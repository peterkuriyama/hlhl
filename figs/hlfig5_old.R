...
one_case1$prop1 <- round(one_case1$prop1, digits = 1)

oc1 <- twospp %>% distinct(prop1, nfish1, nfish2) %>% filter(nfish2 != 0) %>% 
  right_join(one_case1, by = 'prop1')

one_case1 <- oc1
one_case1$prop1 <- one_case1$nfish1

#one_case2
one_case2$prop1 <- round(one_case2$prop1, digits = 1)

oc2 <- twospp %>% distinct(prop1, nfish1, nfish2) %>% filter(nfish2 != 0) %>% 
  right_join(one_case2, by = 'prop1')

one_case2 <- oc2
one_case2$prop1 <- one_case2$nfish1
